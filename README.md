...
### 📋 Requirements
- **Format:** 
  + The report must be typed and clearly formatted, exported as a PDF (recommended to use LaTeX), and is expected to follow the PDF generated by the template provided in the [LaTeX Template](LaTeX%20Template/main-en.tex).
...
- **Định dạng:**  
   + Báo cáo phải được đánh máy, trình bày rõ ràng và xuất ra định dạng PDF (khuyến nghị dùng LaTeX), nên theo mẫu PDF được tạo từ [LaTeX Template](LaTeX%20Template/main-vi.tex).
